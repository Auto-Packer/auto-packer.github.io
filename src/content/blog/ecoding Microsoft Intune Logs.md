...
**What to look for in `AppWorkload.log`:**
...
* **Download Phase:** Watch for the agent requesting the content and creating the download folder (usually routed to `C:\Program Files (x86)\Microsoft Intune Management Extension\Content`).
* **Execution:** Look for the actual install command being triggered and the resulting `Exit Code`.
    * *Exit Code 0:* Success. (If Intune still says the app failed in the portal, your Detection Rule is wrong!).
